...
export const translations = {
  en: {
    ...
    singleShotDesc: "No Tare (Gross Only)",
    singleShotBadge: "GROSS ONLY",
    // Sensors
  ...
  he: {
    ...
    change: "שינוי",
    calcType: "סוג חישוב",
    singleShot: "מדידה ישירה",
    singleShotDesc: "ללא טרה (ברוטו בלבד)",
    singleShotBadge: "ברוטו בלבד",
  ...
  ar: {
    ...
    singleShot: "لقطة واحدة",
    singleShotDesc: "بدون فارغ (إجمالي فقط)",
    singleShotBadge: "إجمالي فقط",
  ...
  ru: {
    ...
    singleShot: "Прямой замер",
    singleShotDesc: "Без тары (Только брутто)",
    singleShotBadge: "ТОЛЬКО БРУТТО",
